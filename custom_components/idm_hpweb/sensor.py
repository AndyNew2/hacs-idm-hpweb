...
SENSOR_TYPES: tuple[SensorEntityDescription, ...] = (
    ...
    SensorEntityDescription(
        key="B52",
        translation_key="flow_temp_heatcircuit_b",
        state_class=SensorStateClass.MEASUREMENT,
        device_class=SensorDeviceClass.TEMPERATURE,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        suggested_display_precision=1,
    ...
    SensorEntityDescription(
        key="B54",
        translation_key="flow_temp_heatcircuit_d",
        state_class=SensorStateClass.MEASUREMENT,
        device_class=SensorDeviceClass.TEMPERATURE,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        suggested_display_precision=1,
    ...
    SensorEntityDescription(key="E32.1", translation_key="siphon_heating"),
    SensorEntityDescription(key="compressor_heating", translation_key="compressor_heating"),
    SensorEntityDescription(key="E1", translation_key="compressor_heating"),
    SensorEntityDescription(key="M13#3", translation_key="fan_direction"),
