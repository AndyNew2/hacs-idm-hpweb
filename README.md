...
6. This integration is actually a compantion, designed to work together with the popular Kodebach iDM Integration see https://github.com/kodebach/hacs-idm-heatpump . However, it still can run alone with no other integration, but you will lack a lot of further information.
7. This integration will without enabling ModbusTCP protocol by your iDM service team. However, I recommend to do so, to be able to run this integration together with the Kodebach integration.
